...
export const HowItWorks = () => {
  ...
  return (
    <section id="how-it-works" className="py-20 md:py-32 bg-white relative overflow-hidden border-t border-slate-100 lg:min-h-screen lg:snap-start lg:snap-always flex items-center">
