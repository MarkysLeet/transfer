...
export const Destinations = () => {
  ...
  return (
    <section id="destinations" className="relative min-h-[80vh] bg-[#FAFAFA] flex items-center py-24 overflow-hidden">

      {/* Immersive Sunset Background */}
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4">
        ...
        <div className="text-center mb-12">
          ...
          <div className="h-1 bg-white/50 w-24 rounded-full mx-auto" />
        </div>

        {/* Embla Cover Flow Carousel */}
        <div className="relative max-w-[1200px] mx-auto overflow-visible py-8 md:py-12">
          <div
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <div className="relative w-full h-64 md:h-80 shrink-0 overflow-hidden rounded-t-3xl group/gallery">
                  ...
                  {/* Optional desktop arrows for gallery */}
                  <button
                    onClick={(e) => {
                      e.stopPropagation();
