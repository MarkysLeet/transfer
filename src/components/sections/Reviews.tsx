...
export const Reviews = () => {
  ...
  return (
    <section id="reviews" className="py-20 md:py-32 bg-[#FAFAFA] relative overflow-hidden border-t border-slate-100 lg:min-h-screen lg:snap-start lg:snap-always flex items-center">
